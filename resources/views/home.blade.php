            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-xl">
                    <article class="card-benefit">
                        ...
                        <p class="online-content sub-text-small mb-0">If you buy a condo with us, You will get a special
                            guaranted</p>
                    </article>
                </div>
                <div class="col-12 col-md-6 col-xl">
                    <article class="card-benefit">
                        ...
                        <p class="online-content sub-text-small mb-0">Your transactions will always be kept confidential
                            and will get discounted</p>
                    </article>
                </div>
                <div class="col-12 col-md-6 col-xl">
                    <article class="card-benefit">
                        ...
                        <p class="online-content sub-text-small mb-0">By buying a condo at our agent you will get a tax
                            discount</p>
                    </article>
                </div>
            </div>
                    ...
                    <article class="card-video-highlight">
                        <a href="#" class="box-click">
                            ...
                            <div class="detail">
                                ...
                                <p class="online-content sub-title mb-0">Project Highlight : Mulberry Grove The Forestias CondO</p>
                    ...
                    <article class="card-project-highlight">
                        <a href="#" class="box-click">
                            ...
                            <section class="detail">
                                ...
                                <p class="online-content sub-text location">
                                    <img src="{{asset( config('images.icons.location'))}}" alt=""> Khlong Toei, Bangkok Near BTS Ekkamai
                                </p>
                            </section>
                        </a>
                    </article>
