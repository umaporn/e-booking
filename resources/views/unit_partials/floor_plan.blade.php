                ...
                <ul class="uk-switcher uk-margin">
                    <li>
                        ...
                        <figure class="img-floor-plan online-content d-flex justify-content-center align-content-center">
                            <img class="img-fluid h-100" src="{{asset('images/unit/ex-building-1.png')}}" alt="">
                        </figure>
                        <div class="col-12 uk-text-center pt-4">
                            <a href="#" class="button link"><img src="{{asset( config('images.icons.download'))}}" alt="">Download
                                                                                                                          Plan</a>
                        </div>
                    </li>
                    <li>
                        ...
                        <figure class="img-floor-plan online-content d-flex justify-content-center align-content-center">
                            <img class="img-fluid h-100" src="{{asset('images/unit/ex-building-2.png')}}" alt="">
                        </figure>
                        <div class="col-12 uk-text-center pt-4">
                            <a href="#" class="button link"><img src="{{asset( config('images.icons.download'))}}" alt="">Download
                                                                                                                          Plan</a>
