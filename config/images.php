...
return [
    ...
    'icons' => [
        ...
        'gototop'    => 'images/icons/icon-gototop.svg',
        'location'   => 'images/icons/icon-location.svg',
        'sqm'        => 'images/icons/icon-sqm.svg',
        'play'       => 'images/icons/icon-play.svg',
        'menu'       => 'images/icons/icon-menu.svg',
        'callcenter' => 'images/icons/footer/icon-callcenter.svg',
        'mail'       => 'images/icons/footer/icon-mail.svg',
        'download'   => 'images/icons/icon-download.svg',
        'viewmore'   => 'images/icons/icon-viewmore.svg',
        'arrow'      => [
            'left'  => 'images/icons/icon-arrow-left.svg',
            'right' => 'images/icons/icon-arrow-right.svg',
        ],
        'benefits'   => [
            'good-1' => 'images/icons/icon-good-1.svg',
            'good-2' => 'images/icons/icon-good-2.svg',
